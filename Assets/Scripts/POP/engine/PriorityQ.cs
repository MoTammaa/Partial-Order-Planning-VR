...
// The code is based on the PriorityQueue class from Microsoft.
...
namespace POP
{
    ...
    public class PriorityQ<TElement, TPriority>
    {
        /// <summary>
        ...
        /// <summary>
        ///  Initializes a new instance of the <see cref="PriorityQ{TElement, TPriority}"/> class.
        /// </summary>
        public PriorityQ()
        {
        ...
        /// </exception>
        public PriorityQ(int initialCapacity)
        ...
        ///  The specified <paramref name="initialCapacity"/> was negative.
        /// </exception>
        public PriorityQ(int initialCapacity, IComparer<TPriority>? comparer)
        {
            ThrowIfNegative<int>(initialCapacity);
        ...
        /// </remarks>
        public PriorityQ(IEnumerable<(TElement Element, TPriority Priority)> items)
        ...
        ///  which is generally faster than enqueuing individual elements sequentially.
        /// </remarks>
        public PriorityQ(IEnumerable<(TElement Element, TPriority Priority)> items, IComparer<TPriority>? comparer)
        {
        ...
        /// <summary>
        ///  Gets the number of elements contained in the <see cref="PriorityQ{TElement, TPriority}"/>.
        /// </summary>
        public int Count => _size;

        /// <summary>
        ///  Gets the priority comparer used by the <see cref="PriorityQ{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Adds the specified element with associated priority to the <see cref="PriorityQ{TElement, TPriority}"/>.
        /// </summary>
        /// <param name="element">The element to add to the <see cref="PriorityQ{TElement, TPriority}"/>.</param>
        ...
        /// <summary>
        ///  Returns the minimal element from the <see cref="PriorityQ{TElement, TPriority}"/> without removing it.
        /// </summary>
        /// <exception cref="InvalidOperationException">The <see cref="PriorityQ{TElement, TPriority}"/> is empty.</exception>
        /// <returns>The minimal element of the <see cref="PriorityQ{TElement, TPriority}"/>.</returns>
        ...
        /// <summary>
        ///  Removes and returns the minimal element from the <see cref="PriorityQ{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Removes the minimal element and then immediately adds the specified element with associated priority to the <see cref="PriorityQ{TElement, TPriority}"/>,
        /// </summary>
        /// <param name="element">The element to add to the <see cref="PriorityQ{TElement, TPriority}"/>.</param>
        /// <param name="priority">The priority with which to associate the new element.</param>
        /// <exception cref="InvalidOperationException">The queue is empty.</exception>
        ...
        /// <summary>
        ///  Removes the minimal element from the <see cref="PriorityQ{TElement, TPriority}"/>,
        ...
        ///  <see langword="false"/> if the <see cref="PriorityQ{TElement, TPriority}"/> is empty.
        /// </returns>
        ...
        /// <summary>
        ///  Returns a value that indicates whether there is a minimal element in the <see cref="PriorityQ{TElement, TPriority}"/>,
        ///  and if one is present, copies it to the <paramref name="element"/> parameter,
        ///  and its associated priority to the <paramref name="priority"/> parameter.
        ///  The element is not removed from the <see cref="PriorityQ{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Enqueues a sequence of element/priority pairs to the <see cref="PriorityQ{TElement, TPriority}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Enqueues a sequence of elements pairs to the <see cref="PriorityQ{TElement, TPriority}"/>,
        ...
        /// <summary>
        ///  Removes all items from the <see cref="PriorityQ{TElement, TPriority}"/>.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        ///  Ensures that the <see cref="PriorityQ{TElement, TPriority}"/> can hold up to
        ...
        /// </exception>
        /// <returns>The current capacity of the <see cref="PriorityQ{TElement, TPriority}"/>.</returns>
        public int EnsureCapacity(int capacity)
        {
            ThrowIfNegative<int>(capacity);
        ...
        /// <summary>
        ///  Sets the capacity to the actual number of items in the <see cref="PriorityQ{TElement, TPriority}"/>,
        ...
        public static void ThrowIfNegative<T>(double value, string? paramName = null)
        {
            if (double.IsNegative(value))
                ThrowNegative(value, paramName);
        }
        public static void ThrowIfNegative<T>(int value, string? paramName = null)
        {
            if (double.IsNegative(value))
                ThrowNegative(value, paramName);
        }
        public static void ThrowIfNegative<T>(decimal value, string? paramName = null)
        {
            if (value < 0)
                ThrowNegative(value, paramName);
        }
        ...
        throw new ArgumentOutOfRangeException(paramName + " " + value + " " + "ArgumentOutOfRange Generic MustBeNonNegative" + " " + paramName + " " + value);


        /// <summary>
        ///  Enumerates the contents of a <see cref="PriorityQ{TElement, TPriority}"/>, without any ordering guarantees.
        /// </summary>
        [DebuggerDisplay("Count = {Count}")]
        [DebuggerTypeProxy(typeof(PriorityQueueDebugView<,>))]
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            internal readonly PriorityQ<TElement, TPriority> _queue;

            internal UnorderedItemsCollection(PriorityQ<TElement, TPriority> queue) => _queue = queue;
            ...
            {
                Helpers.ThrowIfNull(array, nameof(array));

                if (array.Rank != 1)
                {
                    throw new ArgumentException("Argument RankMultiDimNotSupported", nameof(array));
                }

                if (array.GetLowerBound(0) != 0)
                {
                    throw new ArgumentException("Argument NonZeroLowerBound", nameof(array));
                }

                if (index < 0 || index > array.Length)
                {
                    throw new ArgumentOutOfRangeException(nameof(index), index, "ArgumentOutOfRange, IndexMustBeLessOrEqual");
                }
                ...
                {
                    throw new ArgumentException("Argument IncompatibleArrayType", nameof(array));
                }
            }

            /// <summary>
            ///  Enumerates the element and priority pairs of a <see cref="PriorityQ{TElement, TPriority}"/>,
            ///  without any ordering guarantees.
            /// </summary>
            public struct Enumerator : IEnumerator<(TElement Element, TPriority Priority)>
            {
                private readonly PriorityQ<TElement, TPriority> _queue;
                private readonly int _version;
                private int _index;
                private (TElement, TPriority) _current;

                internal Enumerator(PriorityQ<TElement, TPriority> queue)
                {
                    _queue = queue;
                    _index = 0;
                ...
                {
                    PriorityQ<TElement, TPriority> localQueue = _queue;
                ...
                private bool MoveNextRare()
                {
                    ...
                    {
                        throw new InvalidOperationException("InvalidOperation EnumFailedVersion");
                    }
    ...
    internal sealed class PriorityQueueDebugView<TElement, TPriority>
    {
        ...
        public PriorityQueueDebugView(PriorityQ<TElement, TPriority> queue)
        {
            Helpers.ThrowIfNull(queue, nameof(queue));

            _queue = queue;
            _sort = true;
        }

        public PriorityQueueDebugView(PriorityQ<TElement, TPriority>.UnorderedItemsCollection collection)
        {
                    ...
                    if (en.MoveNext())
                    {
                        ...
                        while (en.MoveNext())
                        {
                            if (count == arr.Length)
                            {
                                ...
                                // constrain the length to be int.MaxValue (this overflow check works because of the
                                // cast to uint).
